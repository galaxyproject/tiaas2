...
class TrainingForm(forms.ModelForm):
    class Meta:
        ...
        labels = {
            ...
            'advertise_eu': 'Would you like us to advertise this on our blog?',
        ...
        help_texts = {
            ...
            'advertise_eu': 'We can create an event post and direct users in your region to your training event.',
